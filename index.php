...
$cid = input('get', 'cid', 'd');//根据板块id筛选记录
$page = max(input('get', 'page', 'd'), 1);//查看当前的页码
$type = input('get', 'type', 's');//根据类型筛选博客或排序
$author = input('get', 'author', 'd');//根据作者筛选博客
//拼接查询条件和排序
$where = 'WHERE 1=1 ';
